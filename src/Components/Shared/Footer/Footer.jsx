            ...
            <div className='flex flex-col lg:flex-row justify-between items-start lg:items-center container mx-auto px-4 sm:px-6 py-4 gap-12'>
                ...
                <div className='flex-1 flex justify-center lg:justify-end'>
                    <div className='flex flex-wrap justify-center lg:justify-start gap-3 sm:gap-4 items-center'>
                        <div className='border border-none px-2 py-1 rounded-full hover:text-gray-700 bg-transparent hover:bg-[#FFFFFF] transition-colors duration-300'>
                            <LuGithub className='transition-colors duration-300' size={20} />
                        </div>
                        <div className="group border border-none px-2 py-1 rounded-full bg-transparent hover:bg-[#2B7FFF] transition-colors duration-300">
